...
if __name__ == '__main__':
    ...
    res = {p + '_' + p1 + '_' + p2: {'r': [], 'l': [], 'd': []} for p in args.smod for p1 in args.param1 for p2 in
           args.param2}
    ...
    for t, color in zip([args.smod[0]+'_true_true', args.smod[0]+'_false_false'], list(TABLEAU_COLORS.keys())[len(res.keys()):]):
        for d,l in zip(['l','d'], [':','--']):
